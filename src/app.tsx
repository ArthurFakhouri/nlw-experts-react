...
export function App() {
  ...
  const [notes, setNotes] = useState<Note[]>(() => {
    const notesLocalStorage = localStorage.getItem('@nlw-expert-1.0.0:notes')
  ...
  function onNoteCreated(content: string) {
    ...
    localStorage.setItem('@nlw-expert-1.0.0:notes', JSON.stringify(notesArray))
  }
  ...
  const filteredNotes = search !== '' ? notes.filter(note => note.content
    .toUpperCase()
